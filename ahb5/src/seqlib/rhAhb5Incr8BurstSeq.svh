`ifndef rhAhb5Incr8BurstSeq__svh
`define rhAhb5Incr8BurstSeq__svh
/************************************************************************************/
// Author: RyanHunter
...
class RhAhb5Incr8BurstSeq extends RhAhb5SeqBase;
	
	`uvm_object_utils_begin(RhAhb5Incr8BurstSeq);
	`uvm_object_utils_end

	function new(string name = "RhAhb5Incr8BurstSeq");
		super.new(name);
	endfunction
