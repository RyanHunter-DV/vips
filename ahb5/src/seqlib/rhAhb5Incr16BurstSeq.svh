`ifndef rhAhb5Incr16BurstSeq__svh
`define rhAhb5Incr16BurstSeq__svh
/************************************************************************************/
// Author: RyanHunter
...
class RhAhb5Incr16BurstSeq extends RhAhb5SeqBase;
	
	`uvm_object_utils_begin(RhAhb5Incr16BurstSeq);
	`uvm_object_utils_end

	function new(string name = "RhAhb5Incr16BurstSeq");
		super.new(name);
	endfunction
...
task RhAhb5Incr16BurstSeq::body();
